...
public class ComanndShellbyReverseshells implements MessageCreateListener {

    private ConfigAll config;
    private GenerateFooterInviteLink generatorInvite; //footer own

    /**
     * @param event command Sellby Reverse Shell
     */

    public void onMessageCreate(MessageCreateEvent event) {
        config = new ConfigAll();
        generatorInvite = new GenerateFooterInviteLink();
        Message spravaShell = event.getMessage();
        MessageAuthor author = event.getMessage().getAuthor();
//bash
        if (spravaShell.getContent().equalsIgnoreCase("-shr bash")) {
            long idSave = author.getId(); // save ID user
            new MessageBuilder()
                ...
                messageNew.addReactionAddListener(reactionEvent -> {
                    ...
                    if (reactionEvent.getEmoji().equalsEmoji("\u2754") &&
                        reactionEvent.getUserId() == idSave) {
        ...
        if (spravaShell.getContent().equalsIgnoreCase("-shr perl")) {
            ...
            new MessageBuilder()
                ...
                messageNew.addReactionAddListener(reactionEvent -> {
                    ...
                    if (reactionEvent.getEmoji().equalsEmoji("") && reactionEvent.getUserId() == idSaved) {
                        reactionEvent.editMessage(new EmbedBuilder()
                            .setTitle("****")
                            .setDescription("****" + "\n")
                            .setColor(new Color(95, 212, 96))
        ...
        if (spravaShell.getContent().equalsIgnoreCase("-shr python")) {
            long idSaved = author.getId();
            new MessageBuilder()
                .setEmbed(new EmbedBuilder()
                ...
                message_new.addReactionAddListener(reactionEvent -> {
                    ...
                    } else if (reactionEvent.getEmoji().equalsEmoji("4\uFE0F\u20E3") &&
                        reactionEvent.getUserId() == idSaved) {
                        reactionEvent.editMessage(new EmbedBuilder()
        ...
        if (spravaShell.getContent().equalsIgnoreCase("-shr php")) {
            long idSaved = author.getId();
            new MessageBuilder()
                .setEmbed(new EmbedBuilder()
                ...
                .send(event.getChannel()).thenAccept(messageNew -> {
                messageNew.addReactionAddListener(reactionEvent -> {
                    if (reactionEvent.getEmoji().equalsEmoji("1\uFE0F\u20E3") &&
                        reactionEvent.getUserId() == idSaved) {
                        reactionEvent.editMessage(new EmbedBuilder()
                        ...
                        reactionEvent.editMessage(new EmbedBuilder()
                            .setTitle("**PHP Info**")
                            .setDescription(
                                "Php s a widely-used open source general-purpose scripting language that is especially suited for web development and can be embedded into HTML."
                                    + generatorInvite.generateFooterInviteLinks())
                            .setTimestampToNow()
                            .setColor(new Color(95, 212, 96))
                        );
        ...
        if (spravaShell.getContent().equalsIgnoreCase("-shr ruby")) {
            long idSaved = author.getId();
            new MessageBuilder()
                .setEmbed(new EmbedBuilder()
        ...
        if (spravaShell.getContent().equalsIgnoreCase("-shr java")) {
            long idSaved = author.getId();
            new MessageBuilder()
                .setEmbed(new EmbedBuilder()
        ...
        if (spravaShell.getContent().equalsIgnoreCase("-shr ncat")) {
            long idSaved = author.getId();
            new MessageBuilder()
                .setEmbed(new EmbedBuilder()
        ...
        if (spravaShell.getContent().equalsIgnoreCase("-shr netcat")) {
            long idSaved = author.getId();
            new MessageBuilder()
                .setEmbed(new EmbedBuilder()
        ...
        if (spravaShell.getContent().equalsIgnoreCase("-shr telnet")) {
            long idSaved = author.getId();
            new MessageBuilder()
                .setEmbed(new EmbedBuilder()
