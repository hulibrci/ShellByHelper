...
//bash
            ...
            new MessageBuilder()
                    ...
                    .send(event.getChannel()).thenAccept(message_new -> {
                        ...
                        message_new.addReactionAddListener(reactionEvent -> {
                            ...
                            }else if (reactionEvent.getEmoji().equalsEmoji("1\uFE0F\u20E3") && reactionEvent.getUser().getId() == id_saved)
                            {
                                reactionEvent.editMessage( new EmbedBuilder()
                            ...
                            }else if (reactionEvent.getEmoji().equalsEmoji("2\uFE0F\u20E3") && reactionEvent.getUser().getId() == id_saved)
                            {
                                reactionEvent.editMessage( new EmbedBuilder()
                            ...
                            }else if (reactionEvent.getEmoji().equalsEmoji("3\uFE0F\u20E3") && reactionEvent.getUser().getId() == id_saved)
                            {
                                reactionEvent.editMessage( new EmbedBuilder()
        ...
        if (sprava_shell.getContent().equalsIgnoreCase("-shr python")) {
            ...
            new MessageBuilder()
                ...
                message_new.addReactionAddListener(reactionEvent -> {
                    ...
                    } else if (reactionEvent.getEmoji().equalsEmoji("4\uFE0F\u20E3") && reactionEvent.getUser().getId() == id_saved ){
                        reactionEvent.editMessage( new EmbedBuilder()
        ...
        if (sprava_shell.getContent().equalsIgnoreCase("-shr php")) {
            ...
            new MessageBuilder()
                    ...
                    .send(event.getChannel()).thenAccept(message_new -> {
                        message_new.addReactionAddListener(reactionEvent -> {
                    if (reactionEvent.getEmoji().equalsEmoji("1\uFE0F\u20E3") && reactionEvent.getUser().getId() == id_saved  ) {
                        reactionEvent.editMessage( new EmbedBuilder()
